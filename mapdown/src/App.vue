  ...
  <div class="saas-app-layout">
    ...
    <nav class="global-nav">
      ...
      <div class="nav-tabs">
        ...
        <button
          class="tab-btn plateau-tab"
          :class="{ active: currentTab === 'plateau' }"
          @click="currentTab = 'plateau'"
        >
          <svg class="tab-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
import DownloadEngine from './components/download.vue'
import LocalMapViewer from './components/LocalMapViewer.vue'
import PlateauViewer from './components/PlateauViewer.vue'

const currentTab = ref('download')

const currentComponent = computed(() => {
  switch (currentTab.value) {
    case 'download': return DownloadEngine
    case 'viewer':   return LocalMapViewer
    case 'plateau':  return PlateauViewer
  }
})
</script>
